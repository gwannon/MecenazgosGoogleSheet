...
<body>
  ...
  <p>Estas conclusiones se basan en un estudio realizado en 2022, tiene algunas limitaciones que hay que tener en cuenta al usarlo. Principalmente, la muestra no puede ser considerada representativa del coletivo rolero, no tiene por que estar equivocada y seguramente no lo este o se haya quedado muy cerca de las cifras reales, pero los metodos usados apra obtener los datos no podemos considerarlos los más adecuados. Aun así, no deja de tener su valor y, si bien no sera exacto, nos da una idea muy aproximada de la realidad.</p>
  <p>Se ha considerado que los porcentaje de autores, autoras y autores NB a los que se publica material rolero deberían ser similares a los porcentaje de jugadoras, jugadores NB y jugadores y esto podría no ser correcto.</p>
  <p>Se debería que haber comparado los datos de autores, autoras y autores NB frente al colectivo en general de aficionados españoles con los mismos datos de paises culturamente afines y que pudieran tener una industria rolera parecida, como podŕian ser Italia o Francia. De esa forma se podŕia haber precisado mejor si la correlación entre porcentajes de genero entre personas autoras y personas jugadoras se mantienen o tienen algún tipo de desviación.</p> 
