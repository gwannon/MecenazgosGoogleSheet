...
<body>
  ...
  <p>Estas conclusiones se basan en un estudio realizado en 2022, que si bien es representativo, tiene algunas limitaciones que hay que tener en cuenta al usarlo. Principalmente, la muestra no puede ser considerada representativa del coletivo rolero, no tiene que estar equivocada y seguramente no lo este o se haya quedado muy cerca, pero los metodos usados apra obtener los datos no podemos considerarlos los más adecuados. Aun así, no deja de tener su valor y, si bien no sera exacto, nos da una idea muy aproximada de la realidad.</p>
  <p>Se ha considerado que los porcentaje de autores, autoras y autores NB a los que se publica material rolero deberían ser similares a los porcentaje de jugadoras, jugadores NB y jugadores y podría no ser correcto.</p>
  ...
  <p>Por ahora solo estamos trabajando en el año 2026 y no sabemos si los datos son una cosa excepcional, se mantienen en el tiempo (en sucesivos años) o si hay una tendencia de subida o de bajada. Por suerte, este problema se va a solucionar, ya que la idea del proyecto es recoger datos todos los años. De esta forma podremos estudiar la evolución de este tema.</p>
